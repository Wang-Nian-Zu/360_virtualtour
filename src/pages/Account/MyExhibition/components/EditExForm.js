    ...
    <>
      ...
      <Row className='d-flex justify-content-center m-3'>
        <Row className='w-75'>
          ...
          <Col className='w-50'>
            <input type="text" name="exhibitionName" className="form-control mb-3" placeholder={`展場名稱`} onChange={onChange} value={data.exhibitionName} />
          </Col>
        </Row>
        <Row className='w-75'>
          <Col>
        ...
        <Row className='w-75'>
          ...
          <Col> <input type="date" name="startTime" className="form-control mb-3" onChange={onChange} value={data.startTime} /></Col>
        </Row>
        <Row className='w-75'>
          <Col>
            <h5><span style={{ color: '#d78559' }}>| </span> 結束時間 <span style={{ color: "red" }}>*</span></h5>
          </Col>
          <Col> <input type="date" name="closeTime" className="form-control mb-3" onChange={onChange} value={data.closeTime} /></Col>
        </Row>
        <Row className='w-75'>
          <Col>
          ...
          <Col>
            <select type="dropdown" name="permission" className="form-control mb-3" onChange={onChange} value={data.permission}>
        ...
        <Row className='w-75'>
          ...
          <Col>
            <input type="file" name="frontPicture" className="form-control mb-3" onChange={onFileChange} accept="image/*,.jpg,.png" value={data.frontPicture} />
            {
        ...
        <Row className='w-75'>
          ...
          <Col>
            ...
            {
              (data.picture2File !== null) && (data.picture2File !== "") && (
        ...
        <Row className='w-75'>
          ...
          <Col>
            ...
            {
              (data.picture3File !== null) && (data.picture3File !== "") && (
