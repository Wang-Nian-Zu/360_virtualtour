...
const Phase6Panorama = (props) => {
    ...
    useEffect(() => {
        if (firstSceneisLoad) {
            if (pMusic !== "") {
                document.getElementById("editPMusicUpPanel").onclick = showMusicMenu;
                var sMenu = document.getElementById("editPMusicControls");
                sMenu.style.bottom = "-50px";
                var panelIcon = document.getElementById("editPMusicUpPanel");
        ...
        function showMusicMenu() {
            ...
            if (pos === 0) {
                setMusicMenuIcon("▼");
                document.getElementById("editPMusicUpPanel").onclick = hideMusicMenu;
            }
        }
            ...
            <div className="pannellum" id="panorama6Div">
                {
                    ...
                    && (<ReactPannellum id="panorama" imageSource={image} sceneId={sceneId} style={style} config={config}>
                        ...
                        {(pMusic !== "") && (
                            <div id="editPMusicControls">
                                <div id="editPMusicSlidingMenu" className="editPMusicSlidingMenu">
                                    <div id="editPMusicUpPanel">
                                        <span id="musicMenuIcon" >{musicMenuIcon}</span>
                                    </div>
                                    <div id="editPMusicVmenu" className="editPMusicVmenu" ref={exVmenuRef}>
                                        <span id="editPMusicName" style={{ color: 'black', fontWeight: 'bold' }}>{data.exhibitionName}</span>
                                        <br />
